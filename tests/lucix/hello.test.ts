import { lucix, DocResponse, DocWithId, index, Database, isDatabase } from "@lucix/core";
import { mockSuperThis } from "../helpers.js";

describe("Hello World Test", function () {
  it("should pass the hello world test", function () {
    const result = lucix("hello"); // call to your library function
...
describe("Simplified Reopening a ledger", function () {
  ...
  it("should have the same data on reopen", async () => {
    const db2 = lucix("test-reopen-simple");
